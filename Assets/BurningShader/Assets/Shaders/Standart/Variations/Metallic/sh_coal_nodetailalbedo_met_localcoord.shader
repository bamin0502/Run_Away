...
Shader "Burned/Coal_NoDetailAlbedo_Met_LocalCoord"
{
	Properties
	{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float2 temp_cast_1 = (tex2D( _CoalMasks, ( ( i.uv_texcoord * float2( 0.5,0.5 ) ) + ( float2( 0.005,0.01 ) * _Time.y ) ) ).b).xx;
			float2 lerpResult175 = lerp( ( ( triplanar294.x * 0.5 ) * i.uv_texcoord ) , temp_cast_1 , 0.01);
			...
			float2 temp_cast_3 = (( tex2D( _CoalMasks, ( i.uv_texcoord * 2.0 ) ).g * 0.5 )).xx;
...
/*ASEBEGIN
Version=18912
-1920;6;1920;1013;889.2019;-225.6158;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;296;-4494.289,1054.009;Float;False;Property;_TriplanarScale;TriplanarScale;12;0;Create;True;0;0;0;False;0;False;0.2;1.6;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;305;-4531.613,842.5508;Float;True;Property;_TriplanarMap;TriplanarMap;11;0;Create;True;0;0;0;False;0;False;None;86104a73ce569514d93898e3cd85d452;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.ColorNode;48;-1456.608,57.06815;Float;False;Property;_CoalColor;CoalColor;4;1;[HDR];Create;True;0;0;0;False;0;False;0,0,0,0;6.883182,2.270369,1.189241,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;311;188.148,943.316;Inherit;False;Property;_AO_Coal1;AO_Coal;14;0;Create;True;0;0;0;False;0;False;0;0.58;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;312;345.4482,815.9156;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;239;148.4608,210.0624;Inherit;True;Property;_WoodAoMet_AOR_MetG;WoodAoMet_AO(R)_Met(G);13;0;Create;True;0;0;0;False;0;False;-1;None;cda04cf139859604badb70af62700f4b;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;229;-103.169,548.7671;Inherit;False;224;FirePower;1;0;OBJECT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;267;-62.15375,384.0183;Float;False;Property;_WoodSm;WoodSm;10;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SaturateNode;309;628.1639,332.8024;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=12F1264CACE1E3DA8A4EC97E59B407E6839F5943