...
Shader "Burned/Coal_Met"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float3 lerpResult306 = lerp( ( ( tex2DNode10.rgb * ( ( ( tex2D( _DetailWoodAlbedo, uv_DetailWoodAlbedo ).rgb * (unity_ColorSpaceDouble).rgb ) * temp_output_9_0_g1 ) + appendResult16_g1 ) ) * (1.2 + (FirePower224 - 0.0) * (1.0 - 1.2) / (1.0 - 0.0)) ) , temp_cast_2 , clampResult192);
...
/*ASEBEGIN
Version=18912
-1920;6;1920;1013;1000.914;-385.9717;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;311;162.4355,944.6719;Inherit;False;Property;_AO_Coal1;AO_Coal;20;0;Create;True;0;0;0;False;0;False;0;0.58;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TFHCRemapNode;223;393.3511,-262.9322;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;1.2;False;4;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;239;92.5688,220.5336;Inherit;True;Property;_WoodAoMet_AOR_MetG;WoodAoMet_AO(R)_Met(G);19;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleAddOpNode;312;319.7357,817.2714;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SaturateNode;309;563.4163,362.1931;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=DCE1AD22DE275761AAA7516138666D7683FBBA95