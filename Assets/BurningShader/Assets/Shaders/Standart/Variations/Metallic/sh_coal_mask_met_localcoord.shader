...
Shader "Burned/Coal_Mask_Met_LocalCoord"
{
	Properties
	{
	...
	SubShader
	{
		...
		uniform sampler2D _WoodAoMet_AOR_MetG;
		uniform float4 _WoodAoMet_AOR_MetG_ST;
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float clampResult155 = clamp( ( max( ase_vertexNormal.y , 0.0 ) + ( max( ase_vertex3Pos.y , 0.0 ) * _CinderSidePower ) + clampResult180 ) , 0.0 , 1.0 );
			...
			float3 lerpResult306 = lerp( ( ( tex2DNode10.rgb * ( ( ( tex2D( _DetailWoodAlbedo, uv_DetailWoodAlbedo ).rgb * (unity_ColorSpaceDouble).rgb ) * temp_output_9_0_g1 ) + appendResult16_g1 ) ) * (1.2 + (FirePower224 - 0.0) * (0.0 - 1.2) / (1.0 - 0.0)) ) , temp_cast_2 , clampResult192);
			o.Albedo = lerpResult306;
			float2 temp_cast_4 = (( tex2D( _CoalMasks, ( i.uv_texcoord * 2.0 ) ).g * 0.5 )).xx;
			float2 panner21 = ( 1.0 * _Time.y * float2( 0.15,0 ) + temp_cast_4);
			...
			float2 uv_WoodAoMet_AOR_MetG = i.uv_texcoord * _WoodAoMet_AOR_MetG_ST.xy + _WoodAoMet_AOR_MetG_ST.zw;
			float4 tex2DNode239 = tex2D( _WoodAoMet_AOR_MetG, uv_WoodAoMet_AOR_MetG );
			o.Metallic = tex2DNode239.g;
			...
			float lerpResult238 = lerp( tex2DNode239.r , ( ( temp_output_123_0 * ( 1.0 - ( CoalNoise2206 + clampResult180 ) ) ) + _AO_Coal1 ) , FirePower224);
...
/*ASEBEGIN
Version=18912
-1920;6;1920;1013;660.3524;-15.1785;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;296;-4494.289,1054.009;Float;False;Property;_TriplanarScale;TriplanarScale;21;0;Create;True;0;0;0;False;0;False;0.2;1.6;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;236;-2970.067,-460.4288;Float;False;Property;_UVTiling;UVTiling;14;0;Create;True;0;0;0;False;0;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;178;-3005.34,1289.125;Float;False;Property;_CinderLow;CinderLow;12;0;Create;True;0;0;0;False;0;False;0.18;0.47;0;3;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;157;-2777.392,969.3057;Float;False;Property;_CinderSidePower;CinderSidePower;11;0;Create;True;0;0;0;False;0;False;1.55;1.66;0;3;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;28;-3239.084,1718.399;Float;False;Global;StopBurning;StopBurning;11;0;Create;True;0;0;0;False;0;False;0.5;0.7128749;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;96;-1974.856,928.1199;Float;False;Property;_CinderPower;CinderPower;10;0;Create;True;0;0;0;False;0;False;2;0.65;0;3;0;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;114;-2569.023,1496.635;Inherit;False;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;218;-2498.403,-106.1524;Float;False;Global;StartBurning;StartBurning;19;0;Create;True;0;0;0;False;0;False;0;0.9991112;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;309;-4240.425,825.0985;Float;False;Property;_MaskPower;MaskPower;19;0;Create;True;0;0;0;False;0;False;1.15;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;196;-1075.165,408.9827;Float;False;Property;_AshesPower;AshesPower;13;0;Create;True;0;0;0;False;0;False;3.6;1.23;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;318;192.9975,942.8787;Inherit;False;Property;_AO_Coal1;AO_Coal;20;0;Create;True;0;0;0;False;0;False;0;0.58;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;11;-1170.334,-735.5777;Inherit;True;Property;_WoodNormal;WoodNormal;7;0;Create;True;0;0;0;False;0;False;-1;None;596b33ebc0887e74f8a8eb312c28ca7e;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;255;-67.6104,-440.0819;Inherit;True;Property;_DetailWoodAlbedo;DetailWoodAlbedo;15;0;Create;True;0;0;0;False;0;False;-1;a0fff3e053e70494ba9c91d152aeffa0;69c23a9535a4c2143bdfda7b563b993a;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;48;-1456.608,57.06815;Float;False;Property;_CoalColor;CoalColor;9;1;[HDR];Create;True;0;0;0;False;0;False;0,0,0,0;6.883182,2.270369,1.189241,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TFHCRemapNode;223;501.7276,-288.1722;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;1.2;False;4;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;239;234.8386,226.3186;Inherit;True;Property;_WoodAoMet_AOR_MetG;WoodAoMet_AO(R)_Met(G);22;0;Create;True;0;0;0;False;0;False;-1;None;cda04cf139859604badb70af62700f4b;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;267;-62.15375,381.0183;Float;False;Property;_WoodSm;WoodSm;16;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;319;350.2977,815.4782;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SaturateNode;316;758.6476,343.1785;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
WireConnection;317;0;238;0
WireConnection;0;0;306;0
WireConnection;0;1;273;0
WireConnection;0;2;87;0
WireConnection;0;3;239;2
WireConnection;0;4;316;0
WireConnection;0;5;317;0
WireConnection;0;10;310;0
ASEEND*/
//CHKSM=273E916D4627684FA043F15D70EDFC1809F8328E