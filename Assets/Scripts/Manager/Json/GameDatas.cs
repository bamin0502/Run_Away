...
public class GameDatas : MonoBehaviour
{
    ...
    private void OnSavedGameOpened(SavedGameRequestStatus status, ISavedGameMetadata game)
    {
        if (status == SavedGameRequestStatus.Success)
        {
            ...
            PlayGamesPlatform.Instance.SavedGame.CommitUpdate(game, update, bytes, OnSavedGameWritten);
        }
        else
        {
#if UNITY_EDITOR
    ...
    private void LoadGameData(SavedGameRequestStatus status, ISavedGameMetadata data)
    {
        if (status == SavedGameRequestStatus.Success)
        {
            ...
            PlayGamesPlatform.Instance.SavedGame.ReadBinaryData(data, OnSavedGameDataRead);
        }
        else
        {
#if UNITY_EDITOR
    ...
    private void DeleteSaveGame(SavedGameRequestStatus status, ISavedGameMetadata data)
    {
        if (status == SavedGameRequestStatus.Success)
        {
            ...
            PlayGamesPlatform.Instance.SavedGame.Delete(data);
